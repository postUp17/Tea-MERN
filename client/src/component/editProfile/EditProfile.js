...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextPorps) {
    ...
    //profile object in profile Reducer
    if (nextPorps.profile.profile) {
      const profile = nextPorps.profile.profile;

      const skillCSV = profile.skills.join(",");

      profile.major = !isEmpty(profile.major) ? profile.major : "";
      profile.fieldofstudy = !isEmpty(profile.fieldofstudy)
        ? profile.fieldofstudy
        : "";
      profile.bio = !isEmpty(profile.bio) ? profile.bio : "";
      profile.facebook = !isEmpty(profile.facebook) ? profile.bio : "";
